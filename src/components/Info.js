...
const tempData = [{
    ...
    description: "У відділенні кур'єрської служби «Нова Пошта» замовлення перебуватиме упродовж 5 днів.\n" + "Після завершення цього терміну товар повертається відправнику."
}, {
    title: "Чи потрібна додаткова оплата за переказ коштів у разі післяплати у відділенні Нової Пошти?",
    description: "Додаткової оплати за пересилання коштів у разі післяплати із вашого боку не потрібно.\n" +
    "Вартість замовлення, вказана під час підтвердження замовлення, є остаточною."
}, {
    title: "Чи є можливість відмовитися від частини замовлення в пункті видачі?",
    description: "На жаль, можливості відмовитися від частини замовлення немає. Ви можете відмовитися від неактуального замовлення повністю й оформити нову заявку."
}, {
    title: "Чи можна оплатити замовлення кредитною карткою з-за кордону?",
    description: "Ви можете оплатити замовлення онлайн будь-якою карткою Visa і MasterCard.\n" +
    ...
    description: "Оплата готівкою під час отримання товару можлива в усіх населених пунктах на території України.\n" +
